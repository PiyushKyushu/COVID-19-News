...
All the data and the models created (4 topic models and 1 RoBERTa) for this research has been uploaded on IEEE dataport. The DOI is: (https://dx.doi.org/10.21227/gdq8-ej60.)
...
Further, we have used RoBERTa Classification model to classify COVID-19 News Headlines from UK, India, Japan and South Korea into Positive and Negative sentiments. This repository also contain 'contractions.py' which is require in successfull run of CSV Preprocessing notebook. 
